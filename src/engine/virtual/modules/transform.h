...
namespace drill {
  ...
  public:
    ...
    virtual transform& projection_translate (const vector3_t &v) = 0;
    virtual transform& projection_rotate    (const vector4_t &v) = 0;
    virtual transform& projection_scale     (const vector3_t &v) = 0;
